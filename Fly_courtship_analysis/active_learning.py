...
category_array = category_array_read(write_dir) # Load 
...
new_sampling_sizes = sampling_add(accuracies=accuracies, train_data=train_data, act_multiplier=act_multiplier)
train_data, train_mask, train_labels, category_array = active_learning_select(data=train_data, mask=train_mask, labels=train_labels, category_array=category_array, new_sampling_sizes=new_sampling_sizes)
...
category_array_write(category_arr=category_array, write_dir=write_dir)
